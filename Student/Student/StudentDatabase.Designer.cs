...
namespace Student {
    ...
    public partial class StudentDatabase : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Id, string firstName, string lastName, string phoneNumber, string address, string postalCode, string city, string country) {
            ...
            public string phoneNumber {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'phoneNumber\' dans la table \'Student\' est DBNull.", e);
                    }
                }
                set {
            ...
            public string country {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'country\' dans la table \'Student\' est DBNull.", e);
                    }
                }
                set {
...
namespace Student.StudentDatabaseTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([Id], [firstName], [lastName], [phoneNumber], [address], [postalCode], [city], [country]) VALUES (@Id, @firstName, @lastName, @phoneNumber, @address, @postalCode, @city, @country);
SELECT Id, firstName, lastName, phoneNumber, address, postalCode, city, country FROM Student WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [firstName] = @firstName, [lastName] = @lastName, [phoneNumber] = @phoneNumber, [address] = @address, [postalCode] = @postalCode, [city] = @city, [country] = @country WHERE (([Id] = @Original_Id) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)) AND ((@IsNull_phoneNumber = 1 AND [phoneNumber] IS NULL) OR ([phoneNumber] = @Original_phoneNumber)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_postalCode = 1 AND [postalCode] IS NULL) OR ([postalCode] = @Original_postalCode)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)));
SELECT Id, firstName, lastName, phoneNumber, address, postalCode, city, country FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student.Properties.Settings.Default.StudentDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, firstName, lastName, phoneNumber, address, postalCode, city, country F" +
                "ROM dbo.Student";
        ...
        public virtual int Fill(StudentDatabase.StudentDataTable dataTable) {
        ...
        public virtual StudentDatabase.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDatabase.StudentDataTable dataTable = new StudentDatabase.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDatabase.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_firstName, string Original_lastName, string Original_phoneNumber, string Original_address, string Original_postalCode, string Original_city, string Original_country) {
        ...
        public virtual int Insert(int Id, string firstName, string lastName, string phoneNumber, string address, string postalCode, string city, string country) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string phoneNumber, string address, string postalCode, string city, string country, int Original_Id, string Original_firstName, string Original_lastName, string Original_phoneNumber, string Original_address, string Original_postalCode, string Original_city, string Original_country) {
            return this.Update(Original_Id, firstName, lastName, phoneNumber, address, postalCode, city, country, Original_Id, Original_firstName, Original_lastName, Original_phoneNumber, Original_address, Original_postalCode, Original_city, Original_country);
        }
    }
